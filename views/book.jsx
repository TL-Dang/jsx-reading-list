...
const Book = props =>
    <Fragment>
        ...
        <li id='bookAuthor' data-bookauthor={props.author} className='list-group-item list-group-item-danger'>Author : {props.author}</li>
        ...
        <li id='bookIsRead' data-bookisread={props.isRead} className='list-group-item list-group-item-dark'>{props.isRead ? 'Book already read' : 'Book not read'}</li>
